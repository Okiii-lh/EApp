...
function addDistrict(){
	...
	if(isNull(district)){
		...
		$.ajax({
			...
			url: "http://49.232.119.91:8080/SmartCommunity_war/unit/saveDistrict" ,//url
			data: {
				"city" : city,
				"district" : district
			},
...
function queryDistrict(){
	...
	$.ajax({
		type: "POST",//方法类型
		dataType: "json",//预期服务器返回的数据类型
		url: "http://49.232.119.91:8080/SmartCommunity_war/unit/getDistrictByName" ,//url
		data: {
			"district" : district
		},
		success: function (data) {
...
function update(){
	...
	$.ajax({
		type: "POST",//方法类型
		dataType: "json",//预期服务器返回的数据类型
		url: "http://49.232.119.91:8080/SmartCommunity_war/unit/updateDistrict" ,//url
		data: {
			"district" : district,
			"id":id,
			"city":city
...
function deleteDistrict(){
	...
	$.ajax({
		type: "POST",//方法类型
		dataType: "json",//预期服务器返回的数据类型
		url: "http://49.232.119.91:8080/SmartCommunity_war/unit/deleteDistrict" ,//url
		data: {
			"id":id,
		},
		success: function (data) {
